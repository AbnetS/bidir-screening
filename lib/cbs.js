...
class CBS {
  ...
  async createClient(client, cardId, imgId, branchId) {
    let data = {
      "customerType": 1,
      "name": "Asmamaw, Melaku",
      "branchID": branchId,
      "persons": [
        {
          "title": 0,
          "gender": 0,
          "forenamePartOne": client.first_name,
          "forenamePartTwo": client.last_name,
          "surname": client.grandfather_name,
          "dateOfBirth": moment(client.date_of_birth).format("DD/MM/YYYY"),
          "telephone1": client.phone,
          "pictureID": imgId,
          "cardPictureID": cardId
        }
      ],
      "customerAddress": [
        {
