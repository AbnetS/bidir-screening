...
/**
 * @api {put} /screening/clients/:id/geolocation Update Client Geoloction
 * @apiVersion 1.0.0
 * @apiName UpdateGeolocation
 * @apiGroup Client 
 *
 * @apiDescription Update a Client Geolocation with the given id
 *
 * @apiParam {String} crop Crop Name
